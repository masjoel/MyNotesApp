package com.masjoel.mynotesapp
...
import com.masjoel.mynotesapp.adapter.NoteAdapter
import com.masjoel.mynotesapp.db.NoteHelper
import com.masjoel.mynotesapp.entity.Note
import com.masjoel.mynotesapp.helper.MappingHelper
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rv_notes.layoutManager = linearLayout
